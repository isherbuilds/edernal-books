...
import {
  ...
  DrawerTitle,
  DrawerTrigger
} from "@tsu-stack/ui/components/drawer";
import {
  DropdownMenu,
...
import { useIsMobile } from "@tsu-stack/ui/hooks/use-mobile";
    ...
    cell: ({ row }) => {
      ...
      return (
        <>
          ...
          <Select
            items={[
              { label: "Assign reviewer", value: null },
          ...
          >
            ...
            <SelectContent align="end">
              <SelectGroup>
                <SelectItem value={null}>Assign reviewer</SelectItem>
